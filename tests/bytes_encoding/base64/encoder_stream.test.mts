...
type EncoderOptions = BytesEncoding.Base64.EncoderOptions;
const { EncoderStream } = BytesEncoding.Base64;
...
Deno.test("BytesEncoding.Base64.EncoderStream", async () => {
  await test1([
...
Deno.test("BytesEncoding.Base64.EncoderStream - alphabet:base64url", async () => {
  await test1(
    [
      Uint8Array.of(0x03, 0x02, 0x01, 0x00, 0xFF, 0xFE, 0xFD, 0xFC),
    ],
...
Deno.test("BytesEncoding.Base64.EncoderStream - omitPadding:true", async () => {
  await test1(
    [
      Uint8Array.of(0x03, 0x02, 0x01, 0x00, 0xFF, 0xFE, 0xFD, 0xFC),
    ],
