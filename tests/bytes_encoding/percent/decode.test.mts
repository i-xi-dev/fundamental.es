...
Deno.test("BytesEncoding.Percent.decode() - spaceAsPlus:true", () => {
...
Deno.test("BytesEncoding.Percent.decode() - encodeSet:*", () => {
  const opC = {
    encodeSet: [
      0x20,
      0x21,
