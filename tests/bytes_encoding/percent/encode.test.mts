...
Deno.test("BytesEncoding.Percent.encode()", () => {
...
Deno.test("BytesEncoding.Percent.encode() - encodeSet:*", () => {
  assertStrictEquals(
...
Deno.test("BytesEncoding.Percent.encode() - encodeSet:* 2", () => {
...
Deno.test("BytesEncoding.Percent.encode() - encodeSet:* 3", () => {
  const opE = {
    encodeSet: [
      0x20,
      0x22,
...
Deno.test("BytesEncoding.Percent.encode() - encodeSet:*, spaceAsPlus:true", () => {
  const opF = {
    encodeSet: [
      0x20,
      0x21,
