...
Deno.test("Percent.encode() - encodeSet:*", () => {
  assertStrictEquals(
...
Deno.test("Percent.encode() - encodeSet:* 2", () => {
...
Deno.test("Percent.encode() - encodeSet:* 3", () => {
  const opE = {
    encodeSet: [
      0x20,
      0x22,
...
Deno.test("Percent.encode() - encodeSet:*, spaceAsPlus:true", () => {
  const opF = {
    encodeSet: [
      0x20,
      0x21,
