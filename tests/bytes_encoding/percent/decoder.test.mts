import * as Percent from "../../../src/bytes_encoding/percent/mod.mts";
...
Deno.test("Percent.Decoder.prototype.decode() - spaceAsPlus:true", () => {
...
Deno.test("Percent.Decoder.prototype.decode() - encodeSet:*", () => {
  const decoder3 = new Percent.Decoder();
  ({
    encodeSet: [
      0x20,
      0x21,
