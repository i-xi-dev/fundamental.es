...
const { Decoder } = BytesEncoding.Percent;

const utf8 = new TextEncoder();
const utf8Bytes1 = utf8.encode("1\u{0} !~\u{7F}あ+");

Deno.test("BytesEncoding.Percent.Decoder.prototype.decode()", () => {
...
Deno.test("BytesEncoding.Percent.Decoder.prototype.decode() - spaceAsPlus:true", () => {
...
Deno.test("BytesEncoding.Percent.Decoder.prototype.decode() - encodeSet:*", () => {
