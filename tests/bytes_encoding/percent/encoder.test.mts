...
const { Encoder } = BytesEncoding.Percent;
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode()", () => {
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode() - error", () => {
  const encoder1 = new Encoder();
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode() - encodeSet:*", () => {
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode() - encodeSet:* 2", () => {
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode() - encodeSet:* 3", () => {
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode() - encodeSet:*, spaceAsPlus:true", () => {
...
Deno.test("BytesEncoding.Percent.Encoder.prototype.encode() - encodeSet:*, spaceAsPlus:true X", () => {
  const encoder5 = new Encoder({
    encodeSet: [
      0x20,
      0x21,
