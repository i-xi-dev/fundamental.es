...
Deno.test("Percent.Encoder.prototype.encode()", () => {
  const encoder1 = new Percent.Encoder();
...
Deno.test("Percent.Encoder.prototype.encode() - error", () => {
  const encoder1 = new Percent.Encoder();
...
Deno.test("Percent.Encoder.prototype.encode() - encodeSet:*", () => {
  const encoder2 = new Percent.Encoder({ encodeSet: [] });
  ...
  assertStrictEquals(
    encoder2.encode(utf8Bytes1),
    "%31%00%20%21%7E%7F%E3%81%82%2B",
  );
  assertStrictEquals(encoder2.encode(Uint8Array.of(255)), "%FF");
  assertStrictEquals(encoder2.encode(Uint8Array.of(0)), "%00");
  assertStrictEquals(encoder2.encode(Uint8Array.of(0, 32, 65)), "%00%20%41");
  assertStrictEquals(encoder2.encode(Uint8Array.of(255)), "%FF");
});

Deno.test("Percent.Encoder.prototype.encode() - encodeSet:* 2", () => {
  const encoder3 = new Percent.Encoder({
...
Deno.test("Percent.Encoder.prototype.encode() - encodeSet:* 3", () => {
  const encoder4 = new Percent.Encoder({
    encodeSet: [
      0x20,
      0x22,
      0x23,
...
Deno.test("Percent.Encoder.prototype.encode() - encodeSet:*, spaceAsPlus:true", () => {
  const encoder5 = new Percent.Encoder({
    encodeSet: [
      0x20,
      0x21,
      0x22,
...
Deno.test("Percent.Encoder.prototype.encode() - encodeSet:*, spaceAsPlus:true X", () => {
  const encoder5 = new Percent.Encoder({
    encodeSet: [
      0x20,
      0x21,
  ...
  assertStrictEquals(encoder5.encode(Uint8Array.of()), "");
  assertStrictEquals(encoder5.encode(utf8Bytes1), "1%00%20%21%7E%7F%E3%81%82+");
  assertStrictEquals(encoder5.encode(Uint8Array.of(0, 32, 65)), "%00%20A");
  assertStrictEquals(encoder5.encode(Uint8Array.of(255)), "%FF");
});
