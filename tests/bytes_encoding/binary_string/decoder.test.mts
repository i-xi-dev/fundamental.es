...
const { Decoder } = BytesEncoding.BinaryString;
...
Deno.test("BytesEncoding.BinaryString.Decoder.prototype.decode()", () => {
  test1(
    "\u0003\u0002\u0001\u0000\u00FF\u00FE\u00FD\u00FC\u0000\u0000",
...
Deno.test("BytesEncoding.BinaryString.Decoder.prototype.decode() - error", () => {
  assertThrows(
    () => {
      test1(
        "\u0003\u0002\u0001\u0000\u00FF\u00FE\u00FD\u00FC\u0100\u0000",
