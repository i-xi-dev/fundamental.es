...
function testOr(a: number, b: number) {
  return Numerics.Uint48.bitwiseOr(a, b);
}

Deno.test("Numerics.Uint48.bitwiseOr()", () => {
...
Deno.test("Numerics.Uint48.bitwiseOr() - error", () => {
  assertThrows(
    () => {
      testOr(-1, 0);
    },
