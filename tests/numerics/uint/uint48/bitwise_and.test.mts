...
function testAnd(a: number, b: number) {
  return Numerics.Uint48.bitwiseAnd(a, b);
}

Deno.test("Numerics.Uint48.bitwiseAnd()", () => {
...
Deno.test("Numerics.Uint48.bitwiseAnd() - error", () => {
  assertThrows(
    () => {
      testAnd(-1, 0);
    },
