...
Deno.test("Numerics.Range.safeIntClosedRange()", () => {
  const r1 = Numerics.Range.safeIntClosedRange<number>(1, 4);
...
Deno.test("Numerics.Range.safeIntClosedRange() - error", () => {
  assertThrows(
    () => {
      Numerics.Range.safeIntClosedRange<number>(1n as unknown as number, 4);
    },
    TypeError,
  ...
  assertThrows(
    () => {
      Numerics.Range.safeIntClosedRange<number>(1, 4n as unknown as number);
    },
    TypeError,
    "Input must be a safe-integer of type `number`",
  );
  ...
  assertThrows(
    () => {
      Numerics.Range.safeIntClosedRange<number>(1, Number.NaN);
    },
    TypeError,
    "Input must be a safe-integer of type `number`",
  );
  ...
  assertThrows(
    () => {
      Numerics.Range.safeIntClosedRange<number>(1, Number.POSITIVE_INFINITY);
    },
    TypeError,
    "Input must be a safe-integer of type `number`",
  );
  ...
  assertThrows(
    () => {
      Numerics.Range.safeIntClosedRange<number>(1, 1.5);
    },
    TypeError,
    "Input must be a safe-integer of type `number`",
  );
  ...
  assertThrows(
    () => {
      Numerics.Range.safeIntClosedRange<number>(1, 0);
    },
    RangeError,
...
Deno.test("Numerics.Range.ClosedRange<number>.min", () => {
  const r1 = Numerics.Range.safeIntClosedRange<number>(-1, 0);
  assertStrictEquals(r1.min, -1);
});
...
Deno.test("Numerics.Range.ClosedRange<number>.contains()", () => {
  ...
  const r2 = Numerics.Range.safeIntClosedRange<number>(1, 3);
  ...
  const r3 = Numerics.Range.safeIntClosedRange<number>(5, 5);
...
Deno.test("Numerics.Range.ClosedRange<number>[Symbol.iterator]()", () => {
  const r1i = Numerics.Range.safeIntClosedRange<number>(-1, 0)
    [Symbol.iterator]();
  assertStrictEquals(stringifyNumbers(r1i), "-1,0");

  const r2i = Numerics.Range.safeIntClosedRange<number>(1, 3)
    [Symbol.iterator]();
