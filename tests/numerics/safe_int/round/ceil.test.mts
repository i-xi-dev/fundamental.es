...
Deno.test("Numerics.SafeInt.round() - roundingMode:CEIL", () => {
  const op = RoundingMode.CEIL;

  assertStrictEquals(Numerics.SafeInt.round(-2, op), -2);
  assertStrictEquals(Numerics.SafeInt.round(-1.9, op), -1);
  assertStrictEquals(Numerics.SafeInt.round(-1.8, op), -1);
  assertStrictEquals(Numerics.SafeInt.round(-1.7, op), -1);
  assertStrictEquals(Numerics.SafeInt.round(-1.6, op), -1);
  assertStrictEquals(Numerics.SafeInt.round(-1.5, op), -1);
  ...
  assertStrictEquals(Numerics.SafeInt.round(-0.9, op), 0);
  assertStrictEquals(Numerics.SafeInt.round(-0.8, op), 0);
  assertStrictEquals(Numerics.SafeInt.round(-0.7, op), 0);
  assertStrictEquals(Numerics.SafeInt.round(-0.6, op), 0);
  ...
  assertStrictEquals(Numerics.SafeInt.round(0.1, op), 1);
  assertStrictEquals(Numerics.SafeInt.round(0.2, op), 1);
  assertStrictEquals(Numerics.SafeInt.round(0.3, op), 1);
  assertStrictEquals(Numerics.SafeInt.round(0.4, op), 1);
  ...
  assertStrictEquals(Numerics.SafeInt.round(1, op), 1);
  assertStrictEquals(Numerics.SafeInt.round(1.1, op), 2);
  assertStrictEquals(Numerics.SafeInt.round(1.2, op), 2);
  assertStrictEquals(Numerics.SafeInt.round(1.3, op), 2);
  assertStrictEquals(Numerics.SafeInt.round(1.4, op), 2);
  ...
  assertStrictEquals(Numerics.SafeInt.round(-7.5, op), -7);
  assertStrictEquals(Numerics.SafeInt.round(-6.5, op), -6);
  assertStrictEquals(Numerics.SafeInt.round(-5.5, op), -5);
  assertStrictEquals(Numerics.SafeInt.round(-4.5, op), -4);
  assertStrictEquals(Numerics.SafeInt.round(-3.5, op), -3);
  assertStrictEquals(Numerics.SafeInt.round(-2.5, op), -2);

  assertStrictEquals(Numerics.SafeInt.round(-1.55, op), -1);
  assertStrictEquals(Numerics.SafeInt.round(-1.45, op), -1);
  assertStrictEquals(Numerics.SafeInt.round(-0.55, op), 0);
  assertStrictEquals(Numerics.SafeInt.round(-0.45, op), 0);
  assertStrictEquals(Numerics.SafeInt.round(0.45, op), 1);
  assertStrictEquals(Numerics.SafeInt.round(0.55, op), 1);
  assertStrictEquals(Numerics.SafeInt.round(1.45, op), 2);
