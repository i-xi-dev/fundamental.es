...
const { DecoderStream } = ByteSequence.Encoding.BinaryString;
...
Deno.test("ByteSequence.Encoding.BinaryString.DecoderStream", async () => {
  await test1(
    ["\u0003\u0002\u0001\u0000\u00FF\u00FE\u00FD\u00FC\u0000\u0000"],
...
Deno.test("ByteSequence.Encoding.BinaryString.DecoderStream - error", async () => {
  await assertRejects(
    async () => {
      await test1(
        [
