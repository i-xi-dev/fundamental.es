...
const { Decoder } = ByteSequence.Encoding.Percent;

const utf8 = new TextEncoder();
const utf8Bytes1 = utf8.encode("1\u{0} !~\u{7F}あ+");

Deno.test("ByteSequence.Encoding.Percent.Decoder.prototype.decode()", () => {
  const decoder1 = new Decoder();
...
Deno.test("ByteSequence.Encoding.Percent.Decoder.prototype.decode() - spaceAsPlus:true", () => {
  const decoder2 = new Decoder({ spaceAsPlus: true });
...
Deno.test("ByteSequence.Encoding.Percent.Decoder.prototype.decode() - encodeSet:*", () => {
