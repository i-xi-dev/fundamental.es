...
const { Encoder } = ByteSequence.Encoding.Percent;
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode()", () => {
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode() - error", () => {
  const encoder1 = new Encoder();
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode() - encodeSet:*", () => {
  const encoder2 = new Encoder({ encodeSet: [] });
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode() - encodeSet:* 2", () => {
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode() - encodeSet:* 3", () => {
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode() - encodeSet:*, spaceAsPlus:true", () => {
...
Deno.test("ByteSequence.Encoding.Percent.Encoder.prototype.encode() - encodeSet:*, spaceAsPlus:true X", () => {
  const encoder5 = new Encoder({
    encodeSet: [
      0x20,
      0x21,
