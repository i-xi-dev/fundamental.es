...
Deno.test("ByteSequence.Encoding.Percent.encode()", () => {
  ...
  assertStrictEquals(
    Percent.encode(Uint8Array.of(0, 32, 65)),
    "%00%20%41",
  );
  assertStrictEquals(Percent.encode(Uint8Array.of(255)), "%FF");
});

Deno.test("ByteSequence.Encoding.Percent.encode() - encodeSet:*", () => {
  assertStrictEquals(
    Percent.encode(Uint8Array.of(), { encodeSet: [] }),
    "",
  );
  assertStrictEquals(
    Percent.encode(Uint8Array.of(3, 2, 1, 0, 0xFF, 0xFE, 0xFD, 0xFC), {
...
Deno.test("ByteSequence.Encoding.Percent.encode() - encodeSet:* 2", () => {
  const opD = { encodeSet: [0x20, 0x22, 0x3C, 0x3E, 0x60] };

  assertStrictEquals(Percent.encode(Uint8Array.of(), opD), "");
  assertStrictEquals(
    Percent.encode(utf8Bytes1, opD),
    "1%00%20!~%7F%E3%81%82+",
  );
});

Deno.test("ByteSequence.Encoding.Percent.encode() - encodeSet:* 3", () => {
  const opE = {
    encodeSet: [
      0x20,
      0x22,
  ...
  assertStrictEquals(
    Percent.encode(Uint8Array.of(0, 32, 65), opE),
    "%00%20A",
  );
...
Deno.test("ByteSequence.Encoding.Percent.encode() - encodeSet:*, spaceAsPlus:true", () => {
  const opF = {
    encodeSet: [
      0x20,
      0x21,
  ...
  assertStrictEquals(
    Percent.encode(Uint8Array.of(0, 32, 65), opF),
    "%00+A",
  );
