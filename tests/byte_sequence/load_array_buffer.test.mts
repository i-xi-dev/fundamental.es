...
Deno.test("ByteSequence.prototype.loadArrayBuffer()", () => {
...
Deno.test("ByteSequence.prototype.loadArrayBuffer() - error", () => {
  const b = ByteSequence.create(4);
  assertThrows(
    () => {
...
Deno.test("ByteSequence.prototype.loadArrayBuffer() - insertAt", () => {
  const testdata = Uint8Array.of(255, 254, 253);
