...
Deno.test("TextEncoding.Utf32Le.Encoder", () => {
  ...
  assertThrows(
    () => {
      const e6e = new TextEncoding.Utf32Le.Encoder({ fatal: true });
      e6e.encode("0\uD8001");
    },
    TypeError,
  ...
  const e6a = new TextEncoding.Utf32Le.Encoder();
  assertStrictEquals(
