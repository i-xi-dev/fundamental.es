...
describe("fromCodePoint", () => {
  ...
  it("fromCodePoint(any)", () => {
    expect(() => {
      Rune.fromCodePoint(undefined as unknown as number);
    }).to.throw(TypeError, "codePoint").with.property("name", "TypeError");
...
describe("toCodePoint", () => {
  ...
  it("toCodePoint(any)", () => {
    expect(() => {
      Rune.toCodePoint(undefined as unknown as string);
    }).to.throw(TypeError, "rune").with.property("name", "TypeError");
...
describe("isLetter", () => {
  ...
  it("isLetter(any)", () => {
    expect(() => {
      Rune.isLetter(0 as unknown as string);
    }).to.throw(TypeError, "rune").with.property("name", "TypeError");
...
describe("isControl", () => {
  ...
  it("isControl(any)", () => {
    expect(() => {
      Rune.isControl(0 as unknown as string);
    }).to.throw(TypeError, "rune").with.property("name", "TypeError");
...
describe("isSurrogate", () => {
  ...
  it("isSurrogate(any)", () => {
    expect(() => {
      Rune.isSurrogate(0 as unknown as string);
    }).to.throw(TypeError, "rune").with.property("name", "TypeError");
